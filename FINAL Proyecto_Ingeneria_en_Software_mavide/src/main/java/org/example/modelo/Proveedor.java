...
public class Proveedor {
    ...
    public Proveedor(String id_proveedor, String calle, int numero, String colonia, String rfc, int telefono_1, int telefono_2, String emailp, int cuenta,
                     int id_banco, int envio, String url) {
