...
public class Pedido {
    ...
    public Pedido(int id_pedido, String id_clientes, String id_producto, String id_proveedor, String precio, String rfc, String detalles, String fecha, String url) {
